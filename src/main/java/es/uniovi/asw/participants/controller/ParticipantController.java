...
public class ParticipantController {
	...
	Participant p = data.findLogableUser(loginWrapper.getLogin(), loginWrapper.getPassword());
	...
	if (changePassWrapper == null)
		...
		Participant p = data.findLogableUser(changePassWrapper.getLogin(), changePassWrapper.getPassword());
